...
def get_MiDaS_samples(line, depth_folder, config, specific=None, aft_certain=None):
    lines = [os.path.splitext(os.path.basename(line))[0]]
    samples = []
    ...
    for seq_dir in lines:
        ...
        sdict['ref_img_fi'] = os.path.join(seq_dir + config['img_format'])
